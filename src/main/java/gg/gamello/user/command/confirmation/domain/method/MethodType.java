package gg.gamello.user.command.confirmation.domain.method;

import gg.gamello.user.command.confirmation.domain.secret.EmailFactory;
import gg.gamello.user.command.confirmation.domain.secret.SecretFactory;
import gg.gamello.user.command.confirmation.infrastructure.provider.Communication;
