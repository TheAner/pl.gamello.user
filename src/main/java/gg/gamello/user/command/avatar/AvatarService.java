package gg.gamello.user.command.avatar;
...
import gg.gamello.user.command.avatar.domain.Avatar;
import gg.gamello.user.command.avatar.domain.AvatarSize;
import gg.gamello.user.command.avatar.exception.InvalidFileException;
import gg.gamello.user.command.avatar.properties.AvatarProperties;
