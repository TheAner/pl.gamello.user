package gg.gamello.user.command.confirmation.infrastructure.provider.email;
...
import gg.gamello.user.command.confirmation.infrastructure.provider.Message;
import gg.gamello.user.command.confirmation.infrastructure.provider.MessageBuilder;
