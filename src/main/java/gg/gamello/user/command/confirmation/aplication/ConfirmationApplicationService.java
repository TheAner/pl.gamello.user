package gg.gamello.user.command.confirmation.aplication;
...
import gg.gamello.user.command.confirmation.domain.Confirmation;
import gg.gamello.user.command.confirmation.domain.ConfirmationFactory;
import gg.gamello.user.command.confirmation.domain.ConfirmationRepository;
